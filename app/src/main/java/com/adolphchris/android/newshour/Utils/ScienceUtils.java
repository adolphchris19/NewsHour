...
public class ScienceUtils { private static final String TAG = ScienceUtils.class.getSimpleName();
    private static final String LOG_TAG = ScienceUtils.class.getSimpleName();
    ...
    public static String StringUrlBuilder(){
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter((Constants.QUERY_PARAM), "science, innovation, technology, discovery, wildlife")
    ...
    public static List<NewsFeed> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            Log.e("ScienceUtils", "Problem parsing  NewsFeed JSON result", e);
        }
        return newsFeeds;
    }
}