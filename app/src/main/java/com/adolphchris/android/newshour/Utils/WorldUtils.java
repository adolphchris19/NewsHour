...
public class WorldUtils { private static final String TAG = WorldUtils.class.getSimpleName();
    private static final String LOG_TAG = WorldUtils.class.getSimpleName();
    ...
    public static String StringUrlBuilder(){
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter((Constants.QUERY_PARAM), "international, local, government, politics")
    ...
    public static List<NewsFeed> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            Log.e("WorldUtils", "Problem parsing  NewsFeed JSON result", e);
        }
        return newsFeeds;
    }
}