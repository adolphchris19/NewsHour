...
public class BusinessUtils { private static final String TAG = BusinessUtils.class.getSimpleName();
    private static final String LOG_TAG = BusinessUtils.class.getSimpleName();
    ...
    public static String StringUrlBuilder(){
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter((Constants.QUERY_PARAM), "business, money, finance")
