...
public class SportsUtils { private static final String TAG = SportsUtils.class.getSimpleName();
    private static final String LOG_TAG = SportsUtils.class.getSimpleName();
