...
public class FashionUtils { private static final String TAG = FashionUtils.class.getSimpleName();
    private static final String LOG_TAG = FashionUtils.class.getSimpleName();
    ...
    public static String StringUrlBuilder(){
        ...
        builder.scheme("https")
                ...
                .appendQueryParameter((Constants.QUERY_PARAM), "fashion, cloths, clothing, shoes, jewelry, attire")
    ...
    public static List<NewsFeed> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            Log.e("FashionUtils", "Problem parsing  NewsFeed JSON result", e);
        }
        return newsFeeds;
    }
}